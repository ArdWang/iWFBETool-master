package com.wbt.util.customview.calender;
...
import com.wbt.R;
import com.wbt.util.customview.calender.decorators.SelectorBgDecorator;
import com.wbt.util.customview.calender.decorators.SelectedDayDecorator;
import com.wbt.util.customview.calender.decorators.TodayDecorator;
...
//        window.setGravity(Gravity.BOTTOM);//设置在底部
	...
	private void initData() {
		...
		mCalendarView.addDecorators(new SelectorBgDecorator(mContext),
	...
	private void parseDateToYearMonthDayWeek(Date date){
		...
		//Log.e(TAG, yearStr + "Year" + monthStr + "Month" + dayStr + "Date" + "  " + weekStr);

		mYear.setText(yearStr);

		String formatStr = "%1$s/%2$s  %3$s";
