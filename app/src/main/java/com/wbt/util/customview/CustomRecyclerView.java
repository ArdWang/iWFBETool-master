...
public class CustomRecyclerView extends LinearLayout{
    ...
    public CustomRecyclerView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        View view = LayoutInflater.from(context).inflate(R.layout.custom_recyclerview, this, true);
        ...
        if(wm!=null) {
            ...
            headProgress = view.findViewById(R.id.headprogress);
            headText = view.findViewById(R.id.headerText);


            FooterView = view.findViewById(R.id.footerview);
            footImage = view.findViewById(R.id.footImage);
            footProgress = view.findViewById(R.id.footprogress);
            footText = view.findViewById(R.id.footText);
